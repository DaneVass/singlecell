...
# DESCRIPTION
# Pipeline to automate single cell sample integration using Seurat CCA analysis
...
##------------------------ Get Options ------------------------##
 option_list <- list(
  ...
  make_option(c("--meta"), type="character", dest="meta",
              help="Metadata to add to the sample. Usually a table of cellID with metadata columns. Must contain same cell IDs as the sa    mple."),
